...
public interface ISearchService {
  ...
  RSNodeListResponse search(String query, List<String> resourceTypes, String templateId, List<String> sortList, int limit, int offset, String absoluteUrl, IAuthRequest authRequest) throws IOException;
