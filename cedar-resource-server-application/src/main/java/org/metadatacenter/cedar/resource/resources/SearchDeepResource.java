...
public class SearchDeepResource extends AbstractSearchResource {
  ...
  @ApiOperation(value = "Search resources",
      notes = "Search resources using different criteria. This call can go further than 10.000 resources. It is "
          ...
          + "can see the type of the executed search in the response body.",
