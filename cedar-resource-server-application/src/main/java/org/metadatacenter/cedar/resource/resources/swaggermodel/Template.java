 ...
 */
@Schema(name = "Template", description = "A CEDAR template (open JSON-LD document).")
public class Template {

  @Schema(name = "@id", description = "Unique URL identifier representing a specific template.")
  private String id;
